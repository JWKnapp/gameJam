...
class GameOver {
  ...
  create() {
    ...
    //game over text
    let gameoverLabel = this.game.add.text(
      this.game.world.centerX,
    ...
    let gameOverReflect = this.game.add.text(
      this.game.world.centerX,
    ...
    let grd = gameOverReflect.context.createLinearGradient(
      0,
      0,
      0,
      gameoverLabel.canvas.height
    );
    ...
    //restart text
    let restartText = this.game.add.text(
      this.game.world.centerX,
    ...
    // restart reflection
    let restartReflect = this.game.add.text(
      this.game.world.centerX,
    ...
    let grd2 = restartReflect.context.createLinearGradient(
      0,
      0,
      0,
      restartText.canvas.height
    );
